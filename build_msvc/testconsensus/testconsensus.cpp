...
// pexa includes.
#include <..\src\script\pexaconsensus.h>
...
int main()
{
    std::cout << "pexaconsensus version: " << pexaconsensus_version() << std::endl;
    ...
    auto op0Result = pexaconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, pexaconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
