Building Pexa Core with Visual Studio
========================================
...
Building with Visual Studio is an alternative to the Linux based [cross-compiler build](https://github.com/pexa/pexa/blob/master/doc/build-windows.md).
...
Dependencies
---------------------
A number of [open source libraries](https://github.com/pexa/pexa/blob/master/doc/dependencies.md) are required in order to be able to build Pexa Core.
...
The [external dependencies](https://github.com/pexa/pexa/blob/master/doc/dependencies.md) required for building are:
