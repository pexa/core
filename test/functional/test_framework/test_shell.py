...
class TestShell:
    """Wrapper Class for PexaTestFramework.

    The TestShell class extends the PexaTestFramework
    ...
    class __TestShell(PexaTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by PexaTestFramework child class.
            self.num_nodes = 1
