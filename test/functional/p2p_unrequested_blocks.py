...
class AcceptBlockTest(PexaTestFramework):
    ...
    def run_test(self):
        ...
        all_blocks = []
        for i in range(288):
            next_block = create_block(self.nodes[0], tip.sha256, create_coinbase(i + 4), tip.nTime+1)
            next_block.solve()
        ...
        block_289f = create_block(self.nodes[0], all_blocks[284].sha256, create_coinbase(289), all_blocks[284].nTime+1)
        block_289f.solve()
        block_290f = create_block(self.nodes[0], block_289f.sha256, create_coinbase(290), block_289f.nTime+1)
        block_290f.solve()
        block_291 = create_block(self.nodes[0], block_290f.sha256, create_coinbase(291), block_290f.nTime+1)
        # block_291 spends a coinbase below maturity!
        block_291.vtx.append(create_tx_with_script(block_290f.vtx[0], 0, script_sig=b"42", amount=1))
        block_291.hashMerkleRoot = block_291.calc_merkle_root()
        block_291.solve()
        block_292 = create_block(self.nodes[0], block_291.sha256, create_coinbase(292), block_291.nTime+1)
        block_292.solve()
        ...
        block_293 = create_block(self.nodes[0], block_292.sha256, create_coinbase(293), block_292.nTime+1)
        block_293.solve()
        headers_message = msg_headers()
