...
class TestPexaCli(PexaTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getinfo RPC and `pexa-cli getinfo`")
        ...
        self.log.info("Compare responses from `pexa-cli -getinfo` and the RPCs data is retrieved from.")
