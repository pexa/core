...
"""Verify that starting pexa with -h works as expected."""

from test_framework.test_framework import PexaTestFramework
from test_framework.util import assert_equal

class HelpTest(PexaTestFramework):
    ...
    def run_test(self):
        self.log.info("Start pexa with -h for help text")
        ...
        self.log.info("Start pexa with -version for version information")
        ...
        self.log.info("Start pexad with -fakearg to make sure it does not start")
