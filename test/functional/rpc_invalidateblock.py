...
from test_framework.address import ADDRESS_XCRT1_UNSPENDABLE_DESCRIPTOR
...
class InvalidateTest(PexaTestFramework):
    ...
    def run_test(self):
        ...
        blocks = self.nodes[1].generatetodescriptor(10, ADDRESS_XCRT1_UNSPENDABLE_DESCRIPTOR)
