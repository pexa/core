...
find ${DISTNAME}/bin -type f -executable -exec ../pexacoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
find ${DISTNAME}/lib -type f -exec ../pexacoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
...
mkdir -p ~/pexacoin/depends/SDKs
cp ~/MacOSX10.11.sdk.tar.gz ~/pexacoin/depends/SDKs/MacOSX10.11.sdk.tar.gz
