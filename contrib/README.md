...
Contains files used to package pexad/pexa-qt
for Debian-based Linux systems. If you compile pexad/pexa-qt yourself, there are some useful files here.

### [Gitian-descriptors](/contrib/gitian-descriptors) ###
Files used during the gitian build process. For more information about gitian, see the [the Pexa Core documentation repository](https://github.com/pexacoin/docs).
...
### [RPM](/contrib/rpm) ###
RPM spec file for building pexa-core on RPM based distributions.
...
This script attempts to download and verify the signature file SHA256SUMS.asc from pexacore.org.
