...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the pexa repository."
  exit 1
fi
...
# See https://github.com/pexa/pexa/issues/16064
...
echo 'When compiling pexad, run `./configure` in the following way:'
echo
