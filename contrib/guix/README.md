# Bootstrappable Pexa Core Builds

This directory contains the files necessary to perform bootstrappable Pexa
Core builds.
...
- 24GB of free disk space on the partition that the Pexa Core git repository
  resides in
...
For a Pexa Core depends development environment, simply invoke
...
From the top of a clean Pexa Core repository:
...
To use dongcarl's substitute server for Pexa Core builds after having
