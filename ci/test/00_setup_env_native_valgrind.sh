...
export NO_DEPENDS=1
export TEST_RUNNER_EXTRA="--exclude rpc_bind --factor=2"  # Excluded for now, see https://github.com/pexa/pexa/issues/17765#issuecomment-602068547
export GOAL="install"
export PEXA_CONFIG="--enable-zmq --with-incompatible-bdb --with-gui=no CC=clang CXX=clang++"  # TODO enable GUI
