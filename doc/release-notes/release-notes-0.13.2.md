Pexa Core version 0.13.2 is now available from:

  <https://pexaproject.com/bin/pexa-core-0.13.2/>
...
- #8908 `4a974b2` Update pexa-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow pexa-tx to create v2 transactions (btcdrak)
