Pexa Core version 0.9.1 is now available from:

  https://pexaproject.com/bin/0.9.1/
...
pexad from any pre-0.9.1 version, and have enabled SSL for RPC and
