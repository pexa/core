Pexa version 0.5.4 is now available for download at:
http://sourceforge.net/projects/pexa/files/Pexa/pexa-0.5.4/
...
http://gitorious.org/pexa/pexad-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Pexa-Qt notifications under Growl 1.3.
Increase required age of Pexa-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxPexa properly when installing Pexa-Qt over it. (Windows)
