Pexa-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/pexa/files/Pexa/pexa-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Pexa
...
New/changed settings (command-line or pexa.conf file)
--------------------------------------------------------
