Pexa Core version 0.9.2.1 is now available from:

  https://pexaproject.com/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 PEXA to 0.01 PEXA
...
- Fix "Start pexa on system login"
