...
Pexa Core version 0.19.1 is now available from:

  <https://pexacore.org/bin/pexa-core-0.19.1/>
...
From Pexa Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Pexa Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Pexa Core does not yet change appearance when
...
- #17488 fix "pexad already running" warnings on macOS (fanquake)
