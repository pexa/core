Pexa Core version 0.16.1 is now available from:

  <https://pexacore.org/bin/pexa-core-0.16.1/>
...
- #12843 `df38b13` Test starting pexad with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure pexad processes are cleaned up when tests end (sdaftuar)
