Pexa Core version 0.10.4 is now available from:

  <https://pexaproject.com/bin/pexa-core-0.10.4/>
...
- #6953 `43c2789` Split pexa-tx into its own package
- #6953 `dfe0d4d` Include pexa-tx binary on Debian/Ubuntu
