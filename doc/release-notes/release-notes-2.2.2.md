Pexa Core version *1.0.1* is now available!!
==============

  <https://github.com/pexacoin/core/releases/tag/v1.0.1>
...
If you are upgrading to 1.0.1 from a version before 2.1.0 the chainstate database for this release is 
...
Note: There are no consensus-rule changes between versions 2.1.0 and 1.0.1 - running versions in this range
...
Pexa Core has been tested with macOS 10.14 Mojave, but it is recommended that *developers*
...
Notable changes
==============
*This list includes changes from all releases between 2.1.0 and 1.0.1*
...
- Enhancements for Pexacoin Dev Kit and Mobile Wallet Support
...
Changelog available here: <https://github.com/pexacoin/core/commits/release_1.0.1>
