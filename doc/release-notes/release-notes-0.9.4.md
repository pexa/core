Pexa Core version 0.9.4 is now available from:

  https://pexaproject.com/bin/0.9.4/
...
this update is incompatible with the Pexa system and could lead to consensus
forks.

Pexa Core released binaries from https://pexaproject.com are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~pexa/+archive/ubuntu/pexa
- A third-party or self-compiled Pexa Core

upgrade to Pexa Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
