...
NOTE: At this time it is highly recommended that developers wishing to compile the Pexa Core binaries **DO NOT** upgrade to 
...
Use the following commands to compile a working version of Pexa Core on Mojave (assuming that the instructions in the section "Build 
Pexa Core" has already been followed).  Uninstall Berkeley-db 4.8.3, install the latest version, and _configure_ with the 
...
1. Clone the pexa source code and cd into `pexa`
...
2.  Build pexa-core:
    ...
    Configure and build the headless pexa binaries as well as the GUI (if Qt is found).
...
Before running, it's recommended you create an RPC configuration file.
    ...
    echo -e "rpcuser=pexarpc\nrpcpassword=$(xxd -l 16 -p /dev/urandom)" > "/Users/${USER}/Library/Application Support/Pexa/pexa.conf"

    chmod 600 "/Users/${USER}/Library/Application Support/Pexa/pexa.conf"

The first time you run pexad, it will start downloading the blockchain. This process could take several hours.
...
------------------------
You can use Qt Creator as an IDE, for pexa development.
...
4. Enter "pexa-qt" as project name, enter src/qt as location
