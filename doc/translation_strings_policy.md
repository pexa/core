...
This document provides guidelines for internationalization of the Pexa Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `pexa_en.ts` remains unchanged.
