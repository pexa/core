    ...
    if(role == Qt::DisplayRole || role == Qt::EditRole)
    {
        ...
        case Amount:
            if (rec->recipient.amount == 0 && role == Qt::DisplayRole)
                ...
                return PexaUnits::format(walletModel->getOptionsModel()->getDisplayUnit(), rec->recipient.amount, false, PexaUnits::SeparatorStyle::NEVER);
            else
...
{
    return (this->walletModel->getOptionsModel() != nullptr) ? tr("Requested") + " ("+PexaUnits::shortName(this->walletModel->getOptionsModel()->getDisplayUnit()) + ")" : "";
}
