...
//! Entry point for PexaApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &PexaApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for PexaGUI tests.
void AppTests::guiTests(PexaGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &PexaGUI::consoleShown, this, &AppTests::consoleTests);
