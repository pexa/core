...
private:
    ...
    QString formatTxAmount(const TransactionRecord *wtx, bool showUnconfirmed=true, PexaUnits::SeparatorStyle separators=PexaUnits::SeparatorStyle::STANDARD) const;
