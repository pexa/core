...
#define BUILD_VERSION(maj, min, rev, suffix) \
    "v" STRINGIZE(maj) "." STRINGIZE(min) "." STRINGIZE(rev) suffix

#define BUILD_DESC_DOWNLOAD BUILD_VERSION(CLIENT_VERSION_MAJOR, CLIENT_VERSION_MINOR, CLIENT_VERSION_REVISION, BUILD_SUFFIX)
