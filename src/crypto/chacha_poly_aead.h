...
#ifndef PEXA_CRYPTO_CHACHA_POLY_AEAD_H
#define PEXA_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@pexa.
 *
 ...
 *
 * The chacha20-poly1305@pexa combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@pexa cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@pexa are relatively fast in
...
#endif // PEXA_CRYPTO_CHACHA_POLY_AEAD_H
