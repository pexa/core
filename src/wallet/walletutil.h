...
#ifndef PEXA_WALLET_WALLETUTIL_H
#define PEXA_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! pexa from opening the wallet, thinking it was newly created, and
...
#endif // PEXA_WALLET_WALLETUTIL_H
