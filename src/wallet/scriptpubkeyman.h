...
#ifndef PEXA_WALLET_SCRIPTPUBKEYMAN_H
#define PEXA_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Pexa Core wallet was originally a collection of unrelated private
...
#endif // PEXA_WALLET_SCRIPTPUBKEYMAN_H
